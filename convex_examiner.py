...
def crvstaked_getvalue(myarray, w3, printit=0):
...
def cvxlocked_getvalue(myarray, w3, printit=0):
    cvx_locked = load_contract("0x72a19342e8F1838460eBFCCEf09F6585e32db86E", w3)#convex locked rewards
    try:
        ...
        return [invested, cvxlocked_earned]
    except Exception:
        print("\nupdate cvxlocked exception")
        if not printit:
            return [myarray[-1]["cvxlocked_rewards"][0], myarray[-1]["cvxlocked_rewards"][1]]
...
if __name__ == "__main__":
    ...
    a = crvstaked_getvalue(None, infura_w3, True)
    print(a,"\n\n")
    ...
    print(a,"\n\n")
    a = cvxlocked_getvalue(None, infura_w3, True)
    print(a,"\n\n")
